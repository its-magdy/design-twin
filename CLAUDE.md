...
working in this repo doesn't auto-load `/designtwin:help` / `/designtwin:extract` / `/designtwin:build-screen`.
...
- `ARCHITECTURE.md` — the two-plane design (CLI=read / MCP=write), plugin two-context model, security.
