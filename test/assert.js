// The assertion runner shared by all three suites (harness.js, bridge.test.js, tooling.test.js).
...
//
// `check` is an alias for `ok`, kept because tooling.test.js reads more naturally with it.
//
