...
` : "") + USAGE);
      ...
      const ctx = require_slice_sources().variablesContext(argv, varsFile, fs, path);
...
` : "") + USAGE);
  ...
  const ctx = require_slice_sources().variablesContext(argv, varsFile, fs, path, { sliceFallback: true });
